<template>
  <div
    id="app"
    class="bg-gray-900 py-16 border-t-4 border-indigo-500 min-h-screen antialiased"
  >
    <header>
      <div class="flex justify-center">
        <div class="text-center">
          ...
          <p class="mt-1 text-gray-500 text-sm tracking-wider">
            How To Code Well - March 2020 Code Challenges
          </p>
        </div>
      </div>
    </header>
    ...
    <main class="mt-10 max-w-4xl mx-auto px-4">
      ...
      <div
        class="mt-12 bg-gray-800 rounded-lg shadow-2xl overflow-y-hidden overflow-x-auto"
      >
        <table class="w-full">
          <thead>
            <tr>
